...
(function(){
    ...
    Cluster.prototype.addLabel = function (marker) {
        ...
        label.setStyle({
            height : '25px',
            color : "#fff",
            backgroundColor :'#63A1D4',
            border : 'none',
            borderRadius : "25px",
            fontWeight : 'bold',
        });
        var content = '<span style="color:#63A1D4"><i class="fa fa-map-marker"></i></span>'+'<p style="padding:0px 13px;text-align:center;margin-top:5px;">哈哈这是一sssssssssssssss个点</p>';
